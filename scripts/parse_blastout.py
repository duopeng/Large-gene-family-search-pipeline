...
def main():
	...
	try:
		...
		with open(input_file, "r") as filehandle, open("{}.parsedNfilterout".format(input_file),'w') as writefilehandle:
	...
	try:
		with open(input_fastafile, "r") as handle, open("{}.parsedNfiltered".format(input_file),'w') as writefilehandle2:
