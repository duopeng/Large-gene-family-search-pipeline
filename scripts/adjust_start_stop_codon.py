...
def main():
	...
	#start filtering fasta file
		with open(input_fastafile, "r") as handle, open("result.fasta".format(input_fastafile),'w') as writehandle:
		...
		##count stats
		with open("stats.final.txt", "a") as writehandle, open("result.fasta".format(input_fastafile),'r') as infilehandle:
